...
<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        if($isValid) {
            $stmt = mysqli_prepare($con, "UPDATE reminder SET Reminder_Name=?, Reminder_Date=? WHERE ReminderID='".$id."'");
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/style-edit-reminder.css">
...
<body>
    ...
    <div class="container">
        ...
        <form method="post" action="">
            <header class="header">
                <a href="view-reminder.php?id=<?php echo $id; ?>">
        ...
        <form method="post" action="delete-reminder.php?id=<?php echo $row['ReminderID']; ?>">
            <section class="button-container">
                <div class="update-reminder">
